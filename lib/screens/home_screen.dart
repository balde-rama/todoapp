          ...
          Widget build(BuildContext context) {
            ...
            return Scaffold(
              ...
              Padding(
                ...
                children:[
                IconButton(onPressed: (){}, icon: Icon(Icons.menu,color:  thirdFondColor.withOpacity(.5) )),
                          
                Row(
                children:[
                IconButton(onPressed: (){}, icon: Icon(Icons.search, color: thirdFondColor.withOpacity(.5))),
                          
                IconButton(onPressed: (){}, icon: Icon(Icons.notifications_outlined , color: thirdFondColor.withOpacity(.5),
